defmodule Bio.IO.SnapGene do
  ...
  method does not attempt to do_parse the XML stored within the file. Instead, the
  ...
  @doc"""
  Identical to the read function except this takes a SnapGene file in binary form instead of a file
  path. Returns the contents as a `Bio.IO.SnapGene{}` struct in an :ok tuple.
  """
  @spec parse(content :: binary(), opts :: keyword()) :: {:ok, struct()}
